...
public class Methods {
	...
	/**
	 * alex and abby r the best 
	 * uses the arraySum method to call the sum of the values in the array.
	 * Then divides by the number of integers in the array to find the mean.
	 */
